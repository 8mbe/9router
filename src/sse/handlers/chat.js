...
export async function handleChat(request, clientRawRequest = null) {
    ...
    if (comboStrategy === "fusion") {
      ...
      return handleFusionChat({
        ...
        handleSingleModel: (b, m, isPanel) => {
          ...
          return handleSingleModelChat(b, m, cleanRawReq, request, apiKey, contextMarker);
        },
        log,
        comboName: modelStr,
  ...
  return handleSingleModelChat(body, modelStr, clientRawRequest, request, apiKey, contextMarker);
}

/**
 * Handle single model chat request
 */
async function handleSingleModelChat(body, modelStr, clientRawRequest = null, request = null, apiKey = null, contextMarker = null) {
