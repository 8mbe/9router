...
export async function POST(request, { params }) {
  try {
    ...
    if (action === "exchange") {
      ...
      // Cline, ClinePass and Cline Free use authorization_code without PKCE. Kimchi returns a browser token.
      const noPkceExchangeProviders = ["cline", "clinepass", "cline-free", "kimchi"];
